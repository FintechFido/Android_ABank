package com.example.fintech2020_abank.network;
...
import com.example.fintech2020_abank.function.Login;
        ...
        try {
            ...
            if(jsonObject.has("mode")) {
                ...
                // 로그인 //
                    ...
                    if (jsonObject.getString("result").toString().equals("true")) {
                        // 로그인 성공
                        User.getInstance().set_info(jsonObject.getString("session_key").toString(),
